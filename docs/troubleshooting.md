...
1. If these instructions do not work, your device may be bricked.
    * In the unlikely event that this happens, please follow the [Samilops Bootloop tutorial](https://samilops2.gitbook.io/vita-troubleshooting-guide/serious-problems/bootloop).
